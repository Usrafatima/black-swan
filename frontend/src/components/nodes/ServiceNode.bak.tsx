...
import { Database, Server, Monitor, HardDrive, Cpu, Activity, AlertCircle } from 'lucide-react';
    ...
    <div className={`px-5 py-3 shadow-2xl rounded-sm backdrop-blur-md transition-all duration-500 min-w-[180px] border-l-4 ${
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col">
          <div className="text-[13px] font-black uppercase tracking-tight text-white mb-0.5">{data.label}</div>
          <div className={`text-[9px] font-mono font-bold uppercase tracking-[0.2em] transition-colors duration-500 ${
