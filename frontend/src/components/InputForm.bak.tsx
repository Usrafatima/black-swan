    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      <div className="relative group">
        <textarea
          ...
          placeholder="DESCRIBE_ARCHITECTURE_HERE..."
          className="w-full h-36 p-5 bg-black/40 border border-white/5 rounded-sm text-white placeholder-slate-600 focus:border-cyan-500/50 outline-none resize-none transition-all font-mono text-xs leading-relaxed"
          disabled={isLoading}
        />
